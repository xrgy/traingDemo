...
<body  onload="time()">
<input type="text" name="userId" value="${param.userId}" style="display: none" />
<div class="tabs" >
    <div class="top" id="top">
        <div id="welname" >
            <span id ="spanwelname">欢迎您，${param.userId} </span>
            <%--<span id="dept">${param.deptname}</span>--%>
            <span id="dept"><%=deptname%></span>
        </div>
    ...
    <div class="tab_con">
        <ul class="left_tabs">
            <li class="tab-nav"><a href="../employee/info?userId=${param.userId}" target="if_con">查看个人信息</a></li>
            <li class="tab-nav"><a href="../employee/selection?userId=${param.userId}&deptid=${param.deptid}" target="if_con">学期选课</a></li>
            <li class="tab-nav"><a href="../employee/checkSelection?userId=${param.userId}" target="if_con">查看选课</a></li>
            <li class="tab-nav"><a href="../employee/queryScore?userId=${param.userId}" target="if_con">查询成绩</a></li>
        </ul>
    </div>
    <div class="right_con">
